...
const SearchBar = () => {
    ...
    return (
        <div className={style.searchBar}>
            ...
            <button className={style.desktopButton} onClick={handleShowAll}>Show All</button>
            <div className={style.mobileButton} onClick={handleShowAll}>
                <svg className={style.iconButton} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
